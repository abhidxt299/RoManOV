...
# display the image to our screen -- we will need to click the window open by and press a key on our keyboard to continue execution
cv2.imshow("Image", image)
cv2.waitKey(0)

# access the RGB pixel located at x=50, y=100, keepind in mind that OpenCV stores images in BGR order rather than RGB
(B, G, R) = image[100, 50]
