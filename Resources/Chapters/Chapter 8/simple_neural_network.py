...
# scale the input image pixels to the range [0, 1], then transform the labels into vectors in the range [0, num_classes] -- this generates a vector for each label where the index of the label is set to `1` and all other entries to `0`
